...
class Villager {
  constructor({
    ...
    // constructor({
    //   name: name = 'Guy', hatched: hatched = luxon.DateTime.now().toISO(),
    //   hunger: hunger = 0, hungry_at: hungry_at = 8, eats = 6,
    //   wealth: wealth = 0, inventory: inventory = [],
    //   action: action = 'idle' }) {
